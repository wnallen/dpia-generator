...
- `node` with the `docx` npm package for the Word deliverable; the public `docx` skill for validation.
...
└── references/
    ...
    └── output-template.md            # Section structure, table layouts, cover-page boilerplate
```
